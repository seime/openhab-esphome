...
public class DateMessageHandler extends AbstractMessageHandler<ListEntitiesDateResponse, DateStateResponse> {
    ...
    public void buildChannels(ListEntitiesDateResponse rsp) {
        Configuration configuration = configuration(EntityTypes.DATE, rsp.getKey(), null);
        ...
        Channel channel = ChannelBuilder.create(createChannelUID(handler, rsp.getObjectId(), EntityTypes.DATE))
