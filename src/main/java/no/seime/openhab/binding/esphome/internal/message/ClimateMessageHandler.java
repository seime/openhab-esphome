...
public class ClimateMessageHandler extends AbstractMessageHandler<ListEntitiesClimateResponse, ClimateStateResponse> {
    ...
    public void buildChannels(ListEntitiesClimateResponse rsp) {
        ...
        if (rsp.getSupportedModesCount() > 0) {
            ChannelType channelType = addChannelType("Mode", itemTypeString, Set.of(SEMANTIC_TYPE_CONTROL), "climate",
        ...
        if (rsp.getSupportedFanModesCount() > 0) {
            ChannelType channelType = addChannelType("Fan Mode", itemTypeString, Set.of(SEMANTIC_TYPE_CONTROL, "Wind"),
                    "fan", rsp.getEntityCategory(), rsp.getDisabledByDefault());
            StateDescription stateDescription = optionListStateDescription(
        ...
        if (rsp.getSupportedCustomFanModesCount() > 0) {
            ChannelType channelType = addChannelType("Custom Fan Mode", itemTypeString,
        ...
        if (rsp.getSupportedPresetsCount() > 0) {
            ChannelType channelType = addChannelType("Preset", itemTypeString, Set.of(SEMANTIC_TYPE_CONTROL), "climate",
                    rsp.getEntityCategory(), rsp.getDisabledByDefault());
            StateDescription stateDescription = optionListStateDescription(
        ...
        if (rsp.getSupportedCustomPresetsCount() > 0) {
            ChannelType channelType = addChannelType("Custom Preset", itemTypeString, Set.of(SEMANTIC_TYPE_CONTROL),
        ...
        if (rsp.getSupportedSwingModesCount() > 0) {
            ChannelType channelType = addChannelType("Swing Mode", itemTypeString,
                    Set.of(SEMANTIC_TYPE_CONTROL, "Wind"), "fan", rsp.getEntityCategory(), rsp.getDisabledByDefault());
            StateDescription stateDescription = optionListStateDescription(
    ...
    private void addTargetTemperatureChannel(String channelID, String label, ListEntitiesClimateResponse rsp) {
        ChannelType channelTypeTargetTemperature = addChannelType(label, ITEM_TYPE_TEMPERATURE,
                Set.of(SEMANTIC_TYPE_SETPOINT, "Temperature"), "temperature", rsp.getEntityCategory(),
                rsp.getDisabledByDefault());
        StateDescription stateDescription = numericStateDescription("%.1f %unit%",
